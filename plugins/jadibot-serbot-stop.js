...
if (i < 0) return
await conn.reply(m.chat, `Adios bot :(\n\n> Pausado. Si quiere reanudar use el comando *${usedPrefix}serbot* o su token: ${usedPrefix}getcode`, m)
...
resp = '*⚠️ Este comando sólo puede ser ejecutado por un usuario que sea Sub-Bot*.'
