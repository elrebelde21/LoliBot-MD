let handler = async (m, { conn, usedPrefix, text }) => {
    ...
    const isMainBot = m.sender === global.conn.user.jid; // Verifica si es el bot principal

    if (!isSubBot && !isMainBot) return m.reply('⚠️ Este comando solo puede ser usado por el Bot Principal o un Sub-Bot.');
    ...
    if (!option || !value) {
        return m.reply(`⚠️ Uso: *${usedPrefix}setconfig <opción> <valor>*
