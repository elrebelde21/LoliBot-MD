...
global.canalNombreGB = ["INFINITY-WA 💫", "SkyUltraPlus Host ☁️", "LoliBot ✨", "LoliBot Test ✨"]
...
global.fake = { contextInfo: { mentionedJid: null, forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: channelRD.id, serverMessageId: '', newsletterName: channelRD.name }, externalAdReply: { title: wm, body: vs, mediaType: 1, thumbnailUrl: pp, sourceUrl: redes.getRandom() }}}
