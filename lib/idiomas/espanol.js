...
const smsPrivate = () => { return `𝙑𝙚𝙣 𝙖 𝙢𝙞 𝙥𝙧𝙞𝙫𝙖𝙙𝙤 😏🤭, 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙨𝙚 𝙥𝙪𝙚𝙙𝙚 𝙪𝙩𝙞𝙡𝙞𝙯𝙖𝙧 𝙖𝙡 𝙥𝙧𝙞𝙫𝙖𝙙𝙤` }//AL PRIVADO
const smsAdmin = () => { return `𝙏𝙪 𝙣𝙤 𝙚𝙧𝙚𝙨 𝙖𝙙𝙢𝙞𝙣𝙨 🤣, 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙡𝙤𝙨 𝙥𝙪𝙚𝙙𝙚 𝙪𝙨𝙖𝙧 𝙡𝙤𝙨 𝙖𝙙𝙢𝙞𝙣 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤!!` }//ADMINS
const smsBotAdmin = () => { return `𝙀𝙡 𝘽𝙤𝙩 (𝙔𝙊) 𝙣𝙚𝙘𝙚𝙨𝙞𝙩𝙤 𝙖𝙙𝙢𝙞𝙣𝙨 𝙥𝙖𝙧𝙖 𝙥𝙤𝙙𝙚𝙧 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤, 𝙙𝙖𝙢𝙚 𝙖𝙙𝙢𝙞𝙣𝙨 😏` }//BOT CON ADMIN
