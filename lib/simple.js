...
reply: {
            ...
            value(jid, text = '', quoted, options) {
                return Buffer.isBuffer(text) ? conn.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, text, contextInfo: { mentionedJid: conn.parseMention(text), forwardedNewsletterMessageInfo: { newsletterJid: `120363160031023229@newsletter`, serverMessageId: '', newsletterName: 'INFINITY-WA 💫' }, forwardingScore: 1, isForwarded: true, ...options }}, { quoted, ...options, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
            }
        },
                 //   sendButton: {
            /**
